...
namespace OneWeek2017
{
	public class DocumentationUI
	{
		...
		public void Update(string documentation)
		{
			_docString = documentation;
		}
		...
		public void Draw(SpriteBatch spriteBatch)
		{
			...
			spriteBatch.DrawString(scriptFont, _docString, new Vector2(position.X + (characterSize.X* 3) , position.Y + (characterSize.Y) + (characterSize.Y)), Color.White);
		}
	}
}
